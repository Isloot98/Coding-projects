...
invalidCards.forEach(cards => {
 ...
 switch (firstNumber) {
  case 3:
  if (!naughtyCompanies.includes('Amex (American Express)')) {
              naughtyCompanies.push('Amex (American Express)');
  }
  break;
      case 4:
        if (!naughtyCompanies.includes('Visa')) {
          naughtyCompanies.push('Visa');
        }
        break;
      case 5:
        if (!naughtyCompanies.includes('Mastercard')) {
          naughtyCompanies.push('Mastercard');
        }
        break;
      case 6:
        if (!naughtyCompanies.includes('Discover')) {
  ...
  return naughtyCompanies;
};

const naughtyCompanies = idInvalidCardCompanies(invalidCards);
